...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var r=function(){return(r=Object.assign||function(e){for(var t,r=1,n=arguments.length;r<n;r++)for(var l in t=arguments[r])Object.prototype.hasOwnProperty.call(t,l)&&(e[l]=t[l]);return e}).apply(this,arguments)},n=function(t){t.href||console.warn("A link without 'href' is found\nDEBUG_NOTE "+t.children);var n=t.href||"",l=t.disableDefaultStyles||!1,o=r({},t);return n.startsWith("/")||n.startsWith("#")?o["data-is-internal"]="":(o.target="_blank",o.rel="noopener noreferrer"),o.class=(o.class||"").split(" ").concat([l?"":"styled-link"]).join(" "),o.disableDefaultStyles=null,e.h("a",r({},o))},l=[{route:"/tidbits",text:"Tidbits"},{route:"/projects",text:"Projects"},{route:"/posts",text:"Posts"},{route:"/about",text:"About"}];function o(t){var r=t.children,l=t.route;return e.h(n,{disableDefaultStyles:!0,href:l,class:"nav--link"},r)}function a(t){return e.h(e.Fragment,null,null,e.h("nav",null,t.hideLogo?e.h("div",null):e.h(n,{disableDefaultStyles:!0,href:"/",class:"nav--logo"},"sahithyan"),e.h("input",{type:"checkbox",id:"menu-toggle"}),e.h("label",{for:"menu-toggle",class:"hamburger-icon"}),e.h("ul",null,l.map((function(t){return e.h("li",{key:t.route},e.h(o,{route:t.route},t.text))})))))}function i(){return e.h("footer",null,"© Sahithyan ",2022)}function s(t){var r={repoUrl:"Source",liveUrl:"Demo",writeUpUrl:"Write Up"},l=Object.entries(t.links).map((function(e){var t=e[0],n=e[1];return{displayText:r[t],url:n}}));return e.h("div",{class:"project-card"},e.h("h2",{class:"project-name"},t.name),e.h("p",{class:"project-description"},t.description),e.h("div",{class:"project-links"},l.map((function(t){return e.h(n,{key:t.url,href:t.url},t.displayText)}))))}
/*! *****************************************************************************
    Copyright (c) Microsoft Corporation.
